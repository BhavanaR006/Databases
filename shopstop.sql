...
('PROD007', 'Fresh Tomatoes (1 Kg)', 'CAT002', 'SUP001', 40.00, 0, 15, '2026-02-18', '2026-02-13', 'TOM123456789'),
...
('PROD013', 'Wireless Mouse', 'CAT007', 'SUP007', 450.00, 50, 5, NULL, '2025-07-15', 'MOU123456789'),
...
('PROD022', 'Dog Food (5 Kg)', 'CAT006', 'SUP012', 850.00, 45, 8, '2027-05-31', '2025-06-01', 'DOG123456789'),
...
ORDER BY (p.ReorderLevel - i.CurrentStock) DESC;
