...
Databases/
│
├── Assignment_1/                       ← Schema Design & ER Modelling
...
│
├── Assignment_2/                       ← Indexing & Web Application
│   ├── Assignment2_description.pdf     ← Assignment description
...
│       └── README.md
│
├── Assignment_3/                       ← Transactions, WAL, and ACID
│   ├── Assignment3_description.pdf     ← Assignment description
...
│   │   │   ├── visualisations/        ← Performance charts
│   │   │   └── report_Assignment3.ipynb
│   │   ├── visualisations/            ← Transaction overhead charts
│   │   ├── ModuleA_Report.pdf
│   │   └── README.md
│   │
│   └── Module_B/                       ← ACID testing suite on top of the Flask API
│       ├── app/                        ← Flask app (carried over from Assignment 2)
...
│       │   └── terminal_screenshots/   ← Test run screenshots
│       └── logs/audit.log
│
├── Assignment_4/                       ← Horizontal Sharding
│   ├── Assignment4_description.pdf     ← Assignment description
│   ├── app/
│   │   ├── shard_router.py            ← Core shard routing engine (MD5 hash-based)
│   │   ├── routes/
│   │   │   ├── members.py             ← All reads/writes route to correct shard
│   │   │   ├── sales.py               ← Single-shard lookup + 3-shard range fan-out
│   │   │   └── shards.py              ← Diagnostic/demo endpoints
│   │   └── __init__.py                ← Shard config + custom JSON provider
│   ├── sql/
│   │   ├── schema_moduleB.sql
│   │   └── shard_setup.sql            ← Creates tables on each remote shard
│   ├── Module_B_A3/                    ← ACID tests (carried over from Assignment 3)
│   ├── migrate_to_shards.py           ← Migrates existing data to 3 shards
│   ├── test_sharding.py               ← 6 automated verification tests
│   ├── run.py                          ← Entry point with shard environment variables
│   ├── nexus_report.pdf                ← Final group report
│   └── README.md
│
